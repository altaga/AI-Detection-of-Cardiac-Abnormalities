...
// Working memory
static int8_t _buffer[3200];
static int8_t _state[13008];

// Memory mapped buffers
#define _K5              ((int8_t *)(_state + 0x00000000))   // s8[9808] (9808 bytes) 
#define _K7              ((int8_t *)(_state + 0x00002650))   // s8[3200] (3200 bytes) 
#define _K3              ((float *)(_buffer + 0x00000000))   // f32[800,1] (3200 bytes) 
...
int IMAI_dequeue(float *restrict data_out, float *restrict time_out) {    
    __RETURN_ERROR(fixwin_dequeuef32(_K5, _K3, 40, time_out));
    lowpass_filter_f32(_K3, data_out, _K7, 0.2, 800);
    return 0;
}
